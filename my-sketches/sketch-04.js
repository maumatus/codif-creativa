...
const sketch = () => {
  return ({ context, width, height, frame }) => {
    context.fillStyle = color.style([
      params.background.r, params.background.g, params.background.b]);
    ...
    for (let i = 0; i < numCells; i++) {
      ...
      // const n = random.noise2D(x + frame*10,y,frequency=params.freq)
      const n = random.noise3D(x, y, f * 10, frequency = params.freq)
